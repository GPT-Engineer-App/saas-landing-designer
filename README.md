# saas-landing-designer

A landing page for a SaaS business following design pricniples: 
...
```sh
git clone https://github.com/GPT-Engineer-App/saas-landing-designer.git
cd saas-landing-designer
npm i
```
